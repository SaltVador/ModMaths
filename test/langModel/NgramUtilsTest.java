...
public class NgramUtilsTest {
	...
	public void testGenerateNgrams() {
		vocab.GenerateNgrams("je mange bien",1,3);
		
		assertTrue("je","mange","bien","je mange","mange bien","je mange bien");
		assertFalse("je","mange","bien","je","je mange","mange bien","je","je mange","je mange bien");
	}
